...
const handleSubmitWeight = () => {
  ...
  // Update the pending pickups list by removing the updated pickup and adding it to the completed pickups list
  setPendingPickups((prevPickups) =>
                ...
                renderItem={({ item }) => (
                  <View style={styles.pendingCard}>
                    ...
                    <View style={styles.iconRow}>
                      <Text style={styles.itemStatus}>{item.pickupStatus}</Text>
